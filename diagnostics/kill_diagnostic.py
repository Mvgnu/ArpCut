...
try:
    ...
    from tools.firewall import pf_self_check, block_all_for, unblock_all_for, ensure_pf_enabled, install_anchor
...
try:
    ...
    if hasattr(killer, 'hostblock'):
        ok("Killer.hostblock (host/domain blocklist) exists")
    else:
        fail("Killer.hostblock MISSING!")
        results['critical_issues'].append("hostblock missing")
